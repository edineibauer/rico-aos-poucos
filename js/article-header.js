/**
 * Article Header Template for Rico aos Poucos
 * Centralizes article header rendering across all article pages
 */
...
const ArticleHeader = {
  ...
  // Logo SVG (inline to avoid extra HTTP request)
  getLogoSVG() {
    return `
  ...
  render() {
    ...
    return `
      <a href="${articlesPath}" class="header-back">
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', () => ArticleHeader.init());
} else {
  ArticleHeader.init();
}
