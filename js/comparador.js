  ...
  dadosCrises: {
    ...
    bitcoin: {
      ...
      contexto: `
        ...
        <div class="bitcoin-ciclos">
          ...
          <div class="ciclo-card alta" style="border: 2px solid var(--bullish); background: rgba(63, 185, 80, 0.1);">
            ...
            <div class="ciclo-detalhes">
              <div class="ciclo-stat">
                <div class="ciclo-stat-valor positivo">+688%</div>
                <div class="ciclo-stat-label">Alta até ATH</div>
              </div>
              <div class="ciclo-stat">
                <div class="ciclo-stat-valor">$16k → $126k</div>
        ...
        <p style="margin-top: 20px;"><strong>Padrão de enfraquecimento:</strong> As altas estão diminuindo (+9.900% → +2.900% → +1.600% → +688%), mas as quedas também (-86% → -84% → -77% → ~65%?). Isso indica maturação do ativo.</p>
        ...
        <div style="margin-top: 24px; padding: 12px 16px; background: rgba(88, 166, 255, 0.1); border-radius: 8px; border-left: 4px solid var(--conservador);">
          ...
          <strong>📊 ATH atual:</strong> ~$126.000 (out/2025)
        </div>
        ...
        <div class="bitcoin-ciclos" style="margin-top: 16px;">
          ...
          <div class="ciclo-card" style="border-left: 4px solid var(--bearish);">
            ...
            <p style="margin: 12px 0; color: var(--text-primary); line-height: 1.6;">
              ...
              <strong>Previsão:</strong> Queda de 50-70% do ATH ($126k). Projeção de fundo: $40k-$65k. Pânico na mídia, "Bitcoin está morto".<br>
      ...
      impacto: [
        ...
        { ativo: 'Ciclo 4 (2025)', queda: '?', recuperacao: '?', comportamento: 'Alta +688% | ATH $126k (out/2025)' },
      ...
      evitar: [
        '🚫 Comprar em jan/2026: ~20 meses pós-halving, ATH $126k (out/2025)',
      ...
      oportunidade: [
        '💰 Jan/2026 (data análise): Realizar lucros, ATH $126k atingido',
      ...
      conclusoes: [
        'ANÁLISE: Janeiro/2026, ~20 meses pós-halving, ATH $126k (out/2025)',
      ...
      cenarios: {
        ...
        provavel: {
          ...
          impacto: 'ATH: $126k (out/2025). Fundo 2027-28: $40k-$65k. Pico 2029-30: $180k-$250k.',
          probabilidade: '55%'
        },
        melhor: {
